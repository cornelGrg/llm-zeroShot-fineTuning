...
CONFIGURATIONS=(
  "--test_mode zero --model gemma2 --examples_path examples.csv"
  ...
  "--test_mode few --model gemma3_1b --examples_path examples.csv"
  "--test_mode def --model gemma3_1b --examples_path examples.csv"
  "--test_mode def-few --model gemma3_1b --examples_path examples.csv"
  "--test_mode zero --model gemma2 --examples_path context_examples.csv"
  "--test_mode few --model gemma2 --examples_path context_examples.csv"
  ...
  "--test_mode zero --model gemma3_1b --examples_path context_examples.csv"
  "--test_mode few --model gemma3_1b --examples_path context_examples.csv"
