...
CONFIGURATIONS=(
 "--test_mode zero --model gemma2 --examples_path context_examples.tsv"
 "--test_mode zero --model gemma2 --training --examples_path context_examples.tsv"
 "--test_mode few --model gemma2 --examples_path context_examples.tsv"
 "--test_mode def --model gemma2 --examples_path context_examples.tsv"
 "--test_mode def-few --model gemma2 --examples_path context_examples.tsv"
 "--test_mode zero --model gemma3_1b --examples_path context_examples.tsv"
 "--test_mode zero --model gemma3_1b --training --examples_path context_examples.tsv"
 "--test_mode few --model gemma3_1b --examples_path context_examples.tsv"
 "--test_mode def --model gemma3_1b --examples_path context_examples.tsv"
 "--test_mode def-few --model gemma3_1b --examples_path context_examples.tsv"
 "--test_mode zero --model gemma3n_e2b_it --examples_path context_examples.tsv"
 "--test_mode zero --model gemma3n_e2b_it --training --examples_path context_examples.tsv"
 "--test_mode few --model gemma3n_e2b_it --examples_path context_examples.tsv"
 "--test_mode def --model gemma3n_e2b_it --examples_path context_examples.tsv"
 "--test_mode def-few --model gemma3n_e2b_it --examples_path context_examples.tsv"
)
